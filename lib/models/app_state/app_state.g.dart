...
_$AppState$Impl _$$AppState$ImplFromJson(Map<String, dynamic> json) =>
    _$AppState$Impl(
      ...
      numberOfRegisteredUsers:
          (json['numberOfRegisteredUsers'] as num?)?.toInt(),
      ...
      numberOfFavouritesArtworks:
          (json['numberOfFavouritesArtworks'] as num?)?.toInt(),
      numberOfMessages: (json['numberOfMessages'] as num?)?.toInt(),
      startSubscriptionDate: json['startSubscriptionDate'] == null
          ? null
          : DateTime.parse(json['startSubscriptionDate'] as String),
      endSubscriptionDate: json['endSubscriptionDate'] == null
          ? null
          : DateTime.parse(json['endSubscriptionDate'] as String),
      routeSubscriptionIndex: (json['routeSubscriptionIndex'] as num?)?.toInt(),
    );
...
Map<String, dynamic> _$$AppState$ImplToJson(_$AppState$Impl instance) =>
    <String, dynamic>{
      ...
      'startSubscriptionDate':
          instance.startSubscriptionDate?.toIso8601String(),
      'endSubscriptionDate': instance.endSubscriptionDate?.toIso8601String(),
      'routeSubscriptionIndex': instance.routeSubscriptionIndex,
    };
