...
_$AppState$Impl _$$AppState$ImplFromJson(Map<String, dynamic> json) => _$AppState$Impl(
      ...
      startSubscriptionDate:
          json['startSubscriptionDate'] == null ? null : DateTime.parse(json['startSubscriptionDate'] as String),
      endSubscriptionDate:
          json['endSubscriptionDate'] == null ? null : DateTime.parse(json['endSubscriptionDate'] as String),
...
Map<String, dynamic> _$$AppState$ImplToJson(_$AppState$Impl instance) => <String, dynamic>{
      ...
      'startSubscriptionDate': instance.startSubscriptionDate?.toIso8601String(),
