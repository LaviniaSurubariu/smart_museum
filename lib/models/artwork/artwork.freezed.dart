...
mixin _$Artwork {
  ...
  int get startCreationYear => throw _privateConstructorUsedError;
...
/// @nodoc
@JsonSerializable()
class _$Artwork$Impl implements Artwork$ {
  const _$Artwork$Impl(
      {required this.uid,
      required this.title,
  ...
  _$$Artwork$ImplCopyWith<_$Artwork$Impl> get copyWith =>
      __$$Artwork$ImplCopyWithImpl<_$Artwork$Impl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$Artwork$ImplToJson(
      this,
    );
  }
}

abstract class Artwork$ implements Artwork {
